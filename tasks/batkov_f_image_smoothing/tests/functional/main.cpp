...
const std::array<TestType, 5> kTestParam = {
    std::make_tuple("test1.jpeg", 150.0F), std::make_tuple("test2.jpeg", 100.0F), std::make_tuple("test3.jpeg", 100.0F),
    std::make_tuple("test4.jpeg", 100.0F), std::make_tuple("test5.jpeg", 100.0F),
};
